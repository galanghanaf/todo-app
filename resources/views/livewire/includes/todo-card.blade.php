<div wire:key="{{ $todo->id }}"
    class="todo mb-5 card px-5 py-6 bg-white col-span-1 border-t-2 border-blue-500 drop-shadow-md hover:drop-shadow-lg">
    <div class="flex justify-between space-x-2">
        ...
        <div wire:click.live="edit({{ $todo->id }})" class="flex items-center space-x-2">
